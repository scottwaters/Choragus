...
- Multi-select: click selects, ⌘-click toggles, ⇧-click extends, double-click plays, Delete removes. The context menu acts on the selection: Play, Move to Top / Bottom, Add to Choragus Queue (new or existing), Remove. Dragging a selected row moves the whole block, order preserved, with one reload at the end.
